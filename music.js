...
function preload() {
	img[0] = loadImage('assets/slika6.jpg');
	img[1] = loadImage('assets/slika7.jpg');
	img[2] = loadImage('assets/slika8.jpg');
	img[3] = loadImage('assets/slika9.jpg');
	img[4] = loadImage('assets/slika10.jpg');
	// img[5] = loadImage('assets/slika6.jpg');
	// img[6] = loadImage('assets/slika7.jpg');
	// img[7] = loadImage('assets/slika8.jpg');
	// img[8] = loadImage('assets/slika9.jpg');
	// img[9] = loadImage('assets/slika10.jpg');
  }
